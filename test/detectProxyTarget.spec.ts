...
describe('detectProxyTarget -> eip1193 provider', () => {
  ...
  for (let i = 1; i <= numberOfRuns; i++) {
    it(`detects EIP-1967 - Zora Labs: Contract Factory on run ${i}`, async () => {
      expect(
        await detectProxyTarget('0xF74B146ce44CC162b601deC3BE331784DB111DC1')
